...
- [x] 3. 模糊集的拓扑性质 (Topological Properties of Ambiguity Sets) (Third Section Translated: Completed)
- [x] 4. 最坏期望问题的对偶理论 (Duality Theory for Worst-Case Expectation Problems) (Fourth Section Translated: Completed)
- [x] 5. 最坏风险问题的对偶理论 (Duality Theory for Worst-Case Risk Problems) (Fifth Section Translated: Completed)
